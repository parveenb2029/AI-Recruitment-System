# Interview Question Generation — Execution Flow
...
This document describes the runtime execution path for **Interview Question Generation**, including automation entry points, AI invocation boundaries, human review gates, storage locations, and failure handling.
...
|--------|-----------|----------|
| ATS webhook | REST POST `/hooks/06_Interview_Questions` | Standard |
...
flowchart TD
    ...
    K --> O[Write to 06_Interview_Questions/]
...
| Processed output | `06_Interview_Questions/` | 7 years |
| Failed items | `DLQ/06_Interview_Questions/` | 90 days |
