# Interview Question Generation — Example Input
...
This document provides a realistic example input for **Interview Question Generation** as would be received in production.
...
See `samples/` for full files. Excerpt for **Interview Gen**:
