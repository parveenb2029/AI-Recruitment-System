# Interview Question Generation — Workflow Specification
...
Additional pain points specific to **Interview Gen**:
...
Generate tailored behavioral and technical questions mapped to competencies, with follow-up probes and red-flag guidance.
...
| Artifact Store | Immutable storage under `06_Interview_Questions/` |
...
**Primary trigger:** Candidate approved for interview stage and interview loop defined.
...
- JD JSON
- Candidate profile
- Interview stage (screen/tech/behavioral)
...
- Scoring rubric
- Interviewer briefing doc
- Anti-bias checklist

Outputs are written to `06_Interview_Questions/` with naming convention:  
...
### Phase D — Publication
13. Persist approved artifacts to `06_Interview_Questions/`.
...
7. **BR-07:** Interview Gen-specific: processing SLA = 4 business hours for standard priority.
...
- `06_Interview_Questions/Prompt.md`
- `06_Interview_Questions/Execution_Flow.md`
- `06_Interview_Questions/Automation.md`
...
*End of Workflow Specification — WF-06*
