# Interview Feedback Processing — Workflow Specification
...
Additional pain points specific to **Feedback Processor**:
...
Extract ratings, summarize themes, detect conflicting signals, and highlight evidence-backed strengths and concerns.
...
| Artifact Store | Immutable storage under `07_Interview_Feedback/` |
...
**Primary trigger:** Interviewer submits feedback form or transcript within 24 hours of interview.
...
- Normalized feedback JSON
- Consensus summary
- Hire/no-hire signal
- Calibration flags

Outputs are written to `07_Interview_Feedback/` with naming convention:  
...
### Phase D — Publication
13. Persist approved artifacts to `07_Interview_Feedback/`.
...
7. **BR-07:** Feedback Processor-specific: processing SLA = 4 business hours for standard priority.
...
- `07_Interview_Feedback/Prompt.md`
- `07_Interview_Feedback/Execution_Flow.md`
- `07_Interview_Feedback/Automation.md`
...
*End of Workflow Specification — WF-07*
