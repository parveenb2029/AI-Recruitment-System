# Interview Feedback Processing — Execution Flow
...
This document describes the runtime execution path for **Interview Feedback Processing**, including automation entry points, AI invocation boundaries, human review gates, storage locations, and failure handling.
...
|--------|-----------|----------|
| ATS webhook | REST POST `/hooks/07_Interview_Feedback` | Standard |
...
flowchart TD
    ...
    K --> O[Write to 07_Interview_Feedback/]
...
| Processed output | `07_Interview_Feedback/` | 7 years |
| Failed items | `DLQ/07_Interview_Feedback/` | 90 days |
