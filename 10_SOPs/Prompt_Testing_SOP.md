# Prompt Testing — Standard Operating Procedure

**SOP ID:** SOP-PROMPT_TESTING  
**Version:** 1.0.0  
...
This Standard Operating Procedure (SOP) defines the repeatable process, roles, and controls for **prompt testing** within the AI Recruitment Operations platform. It ensures consistent execution, regulatory compliance, and alignment with enterprise talent acquisition policies.
...
- Prompt library assets and automation integrations supporting prompt testing
