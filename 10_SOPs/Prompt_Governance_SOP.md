# Prompt Governance — Standard Operating Procedure

**SOP ID:** SOP-PROMPT_GOVERNANCE  
**Version:** 1.0.0  
...
This Standard Operating Procedure (SOP) defines the repeatable process, roles, and controls for **prompt governance** within the AI Recruitment Operations platform. It ensures consistent execution, regulatory compliance, and alignment with enterprise talent acquisition policies.
...
- Prompt library assets and automation integrations supporting prompt governance
...
### 5.2 Execution — Prompt Governance
