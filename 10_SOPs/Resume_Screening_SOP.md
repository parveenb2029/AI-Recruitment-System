# Resume Screening — Standard Operating Procedure

**SOP ID:** SOP-RESUME_SCREENING  
**Version:** 1.0.0  
...
This Standard Operating Procedure (SOP) defines the repeatable process, roles, and controls for **resume screening** within the AI Recruitment Operations platform. It ensures consistent execution, regulatory compliance, and alignment with enterprise talent acquisition policies.
...
- Prompt library assets and automation integrations supporting resume screening
...
### 5.2 Execution — Resume Screening
