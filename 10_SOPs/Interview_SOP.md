...
This Standard Operating Procedure (SOP) defines the repeatable process, roles, and controls for **interview process** within the AI Recruitment Operations platform. It ensures consistent execution, regulatory compliance, and alignment with enterprise talent acquisition policies.
...
- Prompt library assets and automation integrations supporting interview process
...
### 5.2 Execution — Interview Process
