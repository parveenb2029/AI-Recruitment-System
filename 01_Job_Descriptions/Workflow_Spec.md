# Job Description Parsing and Management — Workflow Specification
...
Standardize, parse, and govern job descriptions before they enter the recruitment pipeline. This workflow is a core stage in the enterprise AI Recruitment Operations platform. It ensures that every downstream automation receives consistent, auditable inputs while preserving mandatory human oversight at defined approval gates.
...
Additional pain points specific to **JD Parser**:
...
Extract role title, level, must-have vs nice-to-have skills, experience bands, location, and compensation hints into a canonical schema.
...
| Artifact Store | Immutable storage under `01_Job_Descriptions/` |
...
**Primary trigger:** Hiring manager submits or updates a job requisition in the ATS or shared intake folder.
...
- Published JD artifact
- Audit log entry

Outputs are written to `01_Job_Descriptions/` with naming convention:  
...
### Phase D — Publication
13. Persist approved artifacts to `01_Job_Descriptions/`.
...
7. **BR-07:** JD Parser-specific: processing SLA = 4 business hours for standard priority.
...
- `01_Job_Descriptions/Prompt.md`
- `01_Job_Descriptions/Execution_Flow.md`
- `01_Job_Descriptions/Automation.md`
...
*End of Workflow Specification — WF-01*
