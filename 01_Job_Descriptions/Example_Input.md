# Job Description Parsing and Management — Example Input
...
This document provides a realistic example input for **Job Description Parsing and Management** as would be received in production.
...
See `samples/` for full files. Excerpt for **JD Parser**:
