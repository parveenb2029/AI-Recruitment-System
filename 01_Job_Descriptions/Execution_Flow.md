# Job Description Parsing and Management — Execution Flow
...
This document describes the runtime execution path for **Job Description Parsing and Management**, including automation entry points, AI invocation boundaries, human review gates, storage locations, and failure handling.
...
|--------|-----------|----------|
| ATS webhook | REST POST `/hooks/01_Job_Descriptions` | Standard |
...
flowchart TD
    ...
    K --> O[Write to 01_Job_Descriptions/]
...
| Processed output | `01_Job_Descriptions/` | 7 years |
| Failed items | `DLQ/01_Job_Descriptions/` | 90 days |
