# Final Hiring Decision — Execution Flow
...
This document describes the runtime execution path for **Final Hiring Decision**, including automation entry points, AI invocation boundaries, human review gates, storage locations, and failure handling.
...
|--------|-----------|----------|
| ATS webhook | REST POST `/hooks/08_Final_Decision` | Standard |
...
flowchart TD
    ...
    K --> O[Write to 08_Final_Decision/]
...
| Processed output | `08_Final_Decision/` | 7 years |
| Failed items | `DLQ/08_Final_Decision/` | 90 days |
