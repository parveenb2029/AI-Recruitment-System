# Final Hiring Decision — Workflow Specification
...
Additional pain points specific to **Final Decision**:
...
Compile decision dossier, draft offer/rejection communications, and flag compliance or equity anomalies for human approval.
...
| Artifact Store | Immutable storage under `08_Final_Decision/` |
...
**Primary trigger:** All interview stages complete and feedback SLA met.
...
- Offer letter draft or rejection notice
- Audit package
- Onboarding trigger

Outputs are written to `08_Final_Decision/` with naming convention:  
...
### Phase D — Publication
13. Persist approved artifacts to `08_Final_Decision/`.
...
7. **BR-07:** Final Decision-specific: processing SLA = 4 business hours for standard priority.
...
- `08_Final_Decision/Prompt.md`
- `08_Final_Decision/Execution_Flow.md`
- `08_Final_Decision/Automation.md`
...
*End of Workflow Specification — WF-08*
