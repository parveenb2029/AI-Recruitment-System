# Final Hiring Decision — Example Input
...
This document provides a realistic example input for **Final Hiring Decision** as would be received in production.
...
See `samples/` for full files. Excerpt for **Final Decision**:
