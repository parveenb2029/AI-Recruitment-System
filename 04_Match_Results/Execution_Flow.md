# JD-Candidate Matching — Execution Flow
...
This document describes the runtime execution path for **JD-Candidate Matching**, including automation entry points, AI invocation boundaries, human review gates, storage locations, and failure handling.
...
|--------|-----------|----------|
| ATS webhook | REST POST `/hooks/04_Match_Results` | Standard |
...
| Processed output | `04_Match_Results/` | 7 years |
| Failed items | `DLQ/04_Match_Results/` | 90 days |
