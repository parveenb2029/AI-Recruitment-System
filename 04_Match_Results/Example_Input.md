# JD-Candidate Matching — Example Input
...
This document provides a realistic example input for **JD-Candidate Matching** as would be received in production.
...
See `samples/` for full files. Excerpt for **Matcher**:
