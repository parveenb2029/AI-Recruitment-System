# JD-Candidate Matching — Workflow Specification
...
Additional pain points specific to **Matcher**:
...
Compute weighted fit scores, surface skill gaps, and generate explainable rationale tied to resume evidence.
...
| Artifact Store | Immutable storage under `04_Match_Results/` |
...
**Primary trigger:** Validated candidate profile and active JD JSON both available for same requisition.
...
- Matching rubric weights
- DEI guardrails config
...
Outputs are written to `04_Match_Results/` with naming convention:  
...
### Phase D — Publication
13. Persist approved artifacts to `04_Match_Results/`.
...
7. **BR-07:** Matcher-specific: processing SLA = 4 business hours for standard priority.
...
- `04_Match_Results/Prompt.md`
- `04_Match_Results/Execution_Flow.md`
- `04_Match_Results/Automation.md`
...
*End of Workflow Specification — WF-04*
