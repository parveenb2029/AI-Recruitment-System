# Resume Data Extraction — Execution Flow
...
This document describes the runtime execution path for **Resume Data Extraction**, including automation entry points, AI invocation boundaries, human review gates, storage locations, and failure handling.
...
|--------|-----------|----------|
| ATS webhook | REST POST `/hooks/03_Extracted_Data` | Standard |
...
flowchart TD
    ...
    K --> O[Write to 03_Extracted_Data/]
...
| Processed output | `03_Extracted_Data/` | 7 years |
| Failed items | `DLQ/03_Extracted_Data/` | 90 days |
