# Resume Data Extraction — Example Input
...
This document provides a realistic example input for **Resume Data Extraction** as would be received in production.
...
See `samples/` for full files. Excerpt for **Resume Extractor**:
