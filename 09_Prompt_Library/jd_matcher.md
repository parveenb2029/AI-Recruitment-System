# Prompt Library — JD Matcher

**Prompt ID:** LIB-JD_MATCHER  
**Version:** 1.0.0  
...
Production prompt for **JD Matcher** in the AI Recruitment Operations platform. Used across one or more workflows; see cross-references below.
...
```
Execute JD Matcher for the following inputs.
...
Return output conforming to jd_matcher_output schema.
```
...
*End of Prompt Library Entry — JD Matcher*
