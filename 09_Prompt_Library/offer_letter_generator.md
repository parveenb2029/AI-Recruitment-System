# Prompt Library — Offer Letter Generator

**Prompt ID:** LIB-OFFER_LETTER_GENERATOR  
**Version:** 1.0.0  
...
Production prompt for **Offer Letter Generator** in the AI Recruitment Operations platform. Used across one or more workflows; see cross-references below.
...
```
Execute Offer Letter Generator for the following inputs.
...
Return output conforming to offer_letter_generator_output schema.
```
...
*End of Prompt Library Entry — Offer Letter Generator*
