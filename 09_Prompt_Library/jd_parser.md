# Prompt Library — JD Parser

**Prompt ID:** LIB-JD_PARSER  
**Version:** 1.0.0  
...
Production prompt for **JD Parser** in the AI Recruitment Operations platform. Used across one or more workflows; see cross-references below.
...
```
Execute JD Parser for the following inputs.
...
Return output conforming to jd_parser_output schema.
```
...
*End of Prompt Library Entry — JD Parser*
