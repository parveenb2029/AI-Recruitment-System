# Prompt Library — Interview Generator

**Prompt ID:** LIB-INTERVIEW_GENERATOR  
**Version:** 1.0.0  
...
Production prompt for **Interview Generator** in the AI Recruitment Operations platform. Used across one or more workflows; see cross-references below.
...
```
Execute Interview Generator for the following inputs.
...
Return output conforming to interview_generator_output schema.
```
...
*End of Prompt Library Entry — Interview Generator*
