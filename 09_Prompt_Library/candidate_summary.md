# Prompt Library — Candidate Summary

**Prompt ID:** LIB-CANDIDATE_SUMMARY  
**Version:** 1.0.0  
...
Production prompt for **Candidate Summary** in the AI Recruitment Operations platform. Used across one or more workflows; see cross-references below.
...
```
Execute Candidate Summary for the following inputs.
...
Return output conforming to candidate_summary_output schema.
```
...
*End of Prompt Library Entry — Candidate Summary*
