# Prompt Library — Interview Evaluation

**Prompt ID:** LIB-INTERVIEW_EVALUATION  
**Version:** 1.0.0  
...
Production prompt for **Interview Evaluation** in the AI Recruitment Operations platform. Used across one or more workflows; see cross-references below.
...
```
Execute Interview Evaluation for the following inputs.
...
Return output conforming to interview_evaluation_output schema.
```
...
*End of Prompt Library Entry — Interview Evaluation*
