# Prompt Library — Resume Parser

**Prompt ID:** LIB-RESUME_PARSER  
**Version:** 1.0.0  
...
Production prompt for **Resume Parser** in the AI Recruitment Operations platform. Used across one or more workflows; see cross-references below.
...
```
Execute Resume Parser for the following inputs.
...
Return output conforming to resume_parser_output schema.
```
...
*End of Prompt Library Entry — Resume Parser*
