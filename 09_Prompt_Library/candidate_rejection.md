# Prompt Library — Candidate Rejection

**Prompt ID:** LIB-CANDIDATE_REJECTION  
**Version:** 1.0.0  
...
Production prompt for **Candidate Rejection** in the AI Recruitment Operations platform. Used across one or more workflows; see cross-references below.
...
```
Execute Candidate Rejection for the following inputs.
...
Return output conforming to candidate_rejection_output schema.
```
...
*End of Prompt Library Entry — Candidate Rejection*
