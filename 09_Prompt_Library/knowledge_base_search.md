# Prompt Library — Knowledge Base Search

**Prompt ID:** LIB-KNOWLEDGE_BASE_SEARCH  
**Version:** 1.0.0  
...
Production prompt for **Knowledge Base Search** in the AI Recruitment Operations platform. Used across one or more workflows; see cross-references below.
...
```
Execute Knowledge Base Search for the following inputs.
...
Return output conforming to knowledge_base_search_output schema.
```
...
*End of Prompt Library Entry — Knowledge Base Search*
