# Incoming Resume Intake — Example Input
...
This document provides a realistic example input for **Incoming Resume Intake** as would be received in production.
...
See `samples/` for full files. Excerpt for **Resume Intake**:
