# Candidate Shortlisting — Workflow Specification
...
Additional pain points specific to **Shortlist**:
...
Draft shortlist recommendations with risk flags, diversity slate checks, and concise candidate summaries for HM review.
...
| Artifact Store | Immutable storage under `05_Shortlisted/` |
...
**Primary trigger:** Match scores published and SLA window for initial review elapsed or manual review requested.
...
- Match reports
- Recruiter notes
- HM shortlist criteria
- Interview capacity calendar
...
Outputs are written to `05_Shortlisted/` with naming convention:  
...
### Phase D — Publication
13. Persist approved artifacts to `05_Shortlisted/`.
...
7. **BR-07:** Shortlist-specific: processing SLA = 4 business hours for standard priority.
...
- `05_Shortlisted/Prompt.md`
- `05_Shortlisted/Execution_Flow.md`
- `05_Shortlisted/Automation.md`
...
*End of Workflow Specification — WF-05*
