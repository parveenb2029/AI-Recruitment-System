# Candidate Shortlisting — Example Input
...
This document provides a realistic example input for **Candidate Shortlisting** as would be received in production.
...
See `samples/` for full files. Excerpt for **Shortlist**:
