# Candidate Shortlisting — Execution Flow
...
This document describes the runtime execution path for **Candidate Shortlisting**, including automation entry points, AI invocation boundaries, human review gates, storage locations, and failure handling.
...
|--------|-----------|----------|
| ATS webhook | REST POST `/hooks/05_Shortlisted` | Standard |
...
| Processed output | `05_Shortlisted/` | 7 years |
| Failed items | `DLQ/05_Shortlisted/` | 90 days |
